...
abstract class $UserProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, UserProfileModel? profile, String? error});
}
...
class _$UserProfileStateImpl implements _UserProfileState {
  const _$UserProfileStateImpl(
      {this.isLoading = false, this.profile, this.error});
  ...
  @override
  String toString() {
    return 'UserProfileState(isLoading: $isLoading, profile: $profile, error: $error)';
  }
