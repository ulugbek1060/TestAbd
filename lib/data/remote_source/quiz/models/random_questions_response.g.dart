...
_$RandomQuestionsResponseImpl _$$RandomQuestionsResponseImplFromJson(
    ...
    _$RandomQuestionsResponseImpl(
      ...
      results: (json['results'] as List<dynamic>?)
              ?.map((e) =>
                  RandomQuestionModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );

Map<String, dynamic> _$$RandomQuestionsResponseImplToJson(
        _$RandomQuestionsResponseImpl instance) =>
    <String, dynamic>{
...
_$RandomQuestionModelImpl _$$RandomQuestionModelImplFromJson(
        Map<String, dynamic> json) =>
    _$RandomQuestionModelImpl(
      ...
      user: json['user'] == null
          ? null
          : QuestionUserModel.fromJson(json['user'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$RandomQuestionModelImplToJson(
        _$RandomQuestionModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'test': instance.test,
...
_$QuestionUserModelImpl _$$QuestionUserModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$QuestionUserModelImplToJson(
        _$QuestionUserModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
